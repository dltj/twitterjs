...
if(options.withFriends)options.withFriends=false;options['twitterTarget']=target;options['statusCookieName']=(options['statusCookiePrefix']?options['statusCookiePrefix']:"")+target;if(typeof options.enableLinks=='undefined')options.enableLinks=true;window['twitterCallback'+guid]=function(obj){if(options.timeout){clearTimeout(window['twitterTimeout'+guid]);}
