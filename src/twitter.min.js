...
setTweetCookie(options.statusCookieName,ul.innerHTML,options.cookieDomain,options.cookieRefresh);if(typeof options.callback=='function'){options.callback();}};window.getTwitters=function(target,id,count,options){guid++;if(typeof id=='object'){options=id;id=options.id;count=options.count;}
